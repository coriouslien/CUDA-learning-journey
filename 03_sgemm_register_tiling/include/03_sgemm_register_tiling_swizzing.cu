...
ptxas info    : Compile time = 10.295 ms
[ 60%] Building CUDA object CMakeFiles/sgemm_benchmarker.dir/src/sgemm_regs_tiling_runner.cu.o
ptxas info    : 0 bytes gmem
[ 80%] Building CUDA object CMakeFiles/sgemm_benchmarker.dir/kernels/03_sgemm_register_tiling_swizzing.cu.o
ptxas info    : 0 bytes gmem
...
ptxas info    : Function properties for _Z28sgemm_register_tiling_kernelPKfS0_Pfiii
    0 bytes stack frame, 0 bytes spill stores, 0 bytes spill loads
ptxas info    : Used 168 registers, used 1 barriers, 8192 bytes smem
ptxas info    : Compile time = 26.176 ms
...
1. Correctness check
Max error vs CPU: 3.662109e-04
Execution Time: 0.0000 ms
Performance: inf TFLOPS

3. Benchmark
Max error vs CPU: 3.662109e-04
Execution Time: 7.9900 ms
Performance: 17.20 TFLOPS
